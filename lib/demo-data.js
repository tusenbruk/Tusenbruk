...
export const CATEGORIES = [
  ...
  { slug: 'boats', name: 'Boats', icon: 'âµ' },
]
...
People ask me if I'm going to re-teak the deck. They say it would "bring the boat back to life." But the boat is alive. The silver teak is not death â it is maturity. It is the colour of a boat that has been somewhere and come back.

## The Knockdown

In August 2004, I was sailing single-handed from Bergen to Lerwick when a storm system moved in faster than forecast. Sixty knots. The boat was knocked down â beam-ends, mast in the water, cockpit submerged.
...
**Character notes:** Original teak deck Â· silver-patinated Â· cockpit repair 2004 (structural) Â· verdigris bronze fittings Â· Bergen home port.`,
    category: 'boats',
    author_id: '4',
    published: true,
